...
Plugin URI: #
Description: Keeps track of logged In User's search history. After you have activated this plugin, Logged In User check his search history.
Version: 1.1
Author: Dipali Dhole
...
function ursh_list_your_searches ($count) { // display the serach terms
